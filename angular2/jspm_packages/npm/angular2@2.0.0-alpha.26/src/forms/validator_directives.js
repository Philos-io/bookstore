...
var RequiredValidatorDirective = (function() {
  ...
  RequiredValidatorDirective = __decorate([angular2_1.Directive({selector: '[required]'}), __metadata('design:paramtypes', [directives_1.ControlDirective])], RequiredValidatorDirective);
