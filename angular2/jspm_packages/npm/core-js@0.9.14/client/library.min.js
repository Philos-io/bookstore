...
(function(process) {
  !function(a) {
    ...
    !function(c) {
      ...
      function F(a) {
        return y(a) && (g ? "Promise" == q.classof(a) : i in a);
      }
      function E(a, c) {
        return e.FW || a !== b || c !== z ? G(a, c) : !0;
      }
      function n(b) {
        var c = o(b)[x];
        return c != a ? c : b;
      ...
      function l(c) {
        ...
        b.d || (b.d = !0, b = b.r || b, b.v = c, b.s = 2, b.a = b.c.slice(), setTimeout(function() {
          C(function() {
            t(d = b.p) && ("process" == q(k) ? k.emit("unhandledRejection", c, d) : m.console && h(console.error) && console.error("Unhandled promise rejection", c)), b.a = a;
          });
        }, 1), p(b));
      }
      function A(c) {
        ...
        if (!a.d) {
          ...
          try {
            (d = D(c)) ? (b = {
              r: a,
              d: !1
            }, d.call(c, j(A, b, 1), j(l, b, 1))) : (a.v = c, a.s = 1, p(a));
          } catch (e) {
            l.call(b || {
              r: a,
              d: !1
      ...
      var z,
          ...
          g = function() {
            function a(d) {
              var c = new b(d);
              return B(c, a.prototype), c;
            }
            var c = !1;
            try {
              c = h(b) && h(b.resolve) && v(), B(a, b), a.prototype = e.create(b.prototype, {constructor: {value: a}}), a.resolve(5).then(function() {}) instanceof a || (c = !1);
            } catch (d) {
              c = !1;
            }
            return c;
      ...
      g || (b = function(d) {
        ...
        then: function(e, f) {
          var g = o(o(this).constructor)[x],
              c = {
                ok: h(e) ? e : !0,
                fail: h(f) ? f : !1
              },
              j = c.P = new (g != a ? g : b)(function(a, b) {
                c.res = r(a), c.rej = r(b);
              }),
              d = this[i];
      ...
      })), d(d.G + d.W + d.F * !g, {Promise: b}), q.set(b, f), w(b), w(z = e.core[f]), d(d.S + d.F * !g, f, {reject: function(a) {
          return new (n(this))(function(c, b) {
            b(a);
          });
        }}), d(d.S + d.F * (!g || v(!0)), f, {resolve: function(a) {
          return F(a) && E(a.constructor, this) ? a : new this(function(b) {
            b(a);
          });
      ...
      f.exports = function(j, s, v, u, l, m) {
        function n(a) {
          if (c.FW) {
            var d = k[a];
            b(18)(k, a, "delete" == a ? function(a) {
              return d.call(this, 0 === a ? 0 : a);
            } : "has" == a ? function(a) {
              return d.call(this, 0 === a ? 0 : a);
            } : "get" == a ? function(a) {
              return d.call(this, 0 === a ? 0 : a);
            } : "add" == a ? function(a) {
              return d.call(this, 0 === a ? 0 : a), this;
            } : function(a, b) {
              return d.call(this, 0 === a ? 0 : a, b), this;
            });
          }
        }
        var p = c.g[j],
            ...
            k = f && f.prototype,
            t = {};
        if (c.isFunction(f) && (m || !g && k.forEach && k.entries)) {
          var r,
              q = new f,
              w = q[o](m ? {} : -0, 1);
          b(46)(function(a) {
          ...
          }), f.prototype = k, c.FW && (k.constructor = f)), m || q.forEach(function(b, a) {
            r = 1 / a === -(1 / 0);
          }), r && (n("delete"), n("has"), l && n("get")), (r || w !== q) && n(o);
        } else
          f = u.getConstructor(s, j, l, o), b(59)(f.prototype, v), f.prototype.constructor = f;
        return b(5).set(f, j), t[j] = f, d(d.G + d.W + d.F * (f != p), t), e(f), e(c.core[j]), m || u.setIter(f, j, l), f;
      };
    }, function(c, d, a) {
      var b = a(61);
      a(62)("Set", function(a) {
