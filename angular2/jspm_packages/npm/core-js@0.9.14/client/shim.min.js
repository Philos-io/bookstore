    ...
    !function(c) {
      ...
      f.exports = function(j, s, v, u, l, m) {
        ...
        if (c.isFunction(f) && (m || !g && k.forEach && k.entries)) {
          ...
          f = u.getConstructor(s, j, l, o), b(63)(f.prototype, v), f.prototype.constructor = f;
        return b(12).set(f, j), t[j] = f, d(d.G + d.W + d.F * (f != p), t), e(f), e(c.core[j]), m || u.setIter(f, j, l), f;
      };
    }, function(c, d, a) {
      var b = a(65);
      a(66)("Set", function(a) {
